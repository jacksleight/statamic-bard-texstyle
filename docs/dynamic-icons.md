...
<div class="bts-icons">
  <div>
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
        ...
        <text text-anchor="middle" x="12.75" y="15" style="font-size: 10px; stroke-width: 1px; stroke: currentColor">T</text>
    </svg>
    <span>letter / T</span>
  </div>
  <div>
  ...
  <div>
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
        ...
        <rect width="15" height="15" x="0.5" y="0.5" rx="2" stroke-width="1" stroke="currentColor" mask="url(#mask-1)" />
    </svg>
  ...
  <div>
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
        ...
        <circle cx="8" cy="8" r="7.5" stroke-width="1" stroke="currentColor" mask="url(#mask-2)" />
    </svg>
