...
const icons = {
    ...
    modern: {
        'letter': (style) => {
            ...
            const letterPath = {
                H: '<path d="M1.714,6.88L7.143,6.88L7.143,1.429C7.143,1.113 7.399,0.857 7.714,0.857C8.03,0.857 8.286,1.113 8.286,1.429L8.286,14.571C8.286,14.887 8.03,15.143 7.714,15.143C7.399,15.143 7.143,14.887 7.143,14.571L7.143,8.023L1.714,8.023L1.714,14.571C1.714,14.887 1.458,15.143 1.143,15.143C0.827,15.143 0.571,14.887 0.571,14.571L0.571,1.429C0.571,1.113 0.827,0.857 1.143,0.857C1.458,0.857 1.714,1.113 1.714,1.429L1.714,6.88Z"/>',
