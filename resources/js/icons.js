...
const coreIcons = {
    ...
    hidden: `
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
            <path d="M3.812 3.027A8.326 8.326 0 0 1 15.977 7.84a.552.552 0 0 1 0 .317 8.344 8.344 0 0 1-2.853 4.182l1.926 1.926a.555.555 0 0 1-.785.784l-2.387-2.387-2.701-2.7-3.138-3.139-2.7-2.7L.951 1.735a.555.555 0 1 1 .785-.784l2.076 2.076Zm2.659 2.66a2.775 2.775 0 0 1 1.53-.461A2.788 2.788 0 0 1 10.775 8c0 .548-.163 1.079-.46 1.53l2.017 2.017a7.222 7.222 0 0 0 2.532-3.549A7.217 7.217 0 0 0 4.628 3.843l1.843 1.844Zm3.032 3.031c.106-.222.162-.467.162-.718 0-.913-.751-1.664-1.664-1.664-.251 0-.496.056-.718.162l2.22 2.22Zm-7.858-3.87a.555.555 0 1 1 .846.717 7.202 7.202 0 0 0-1.355 2.436 7.216 7.216 0 0 0 8.831 4.721.554.554 0 1 1 .302 1.067A8.326 8.326 0 0 1 .023 8.158a.552.552 0 0 1 0-.317 8.295 8.295 0 0 1 1.622-2.993Z"/>
        </svg>
    `,
}
