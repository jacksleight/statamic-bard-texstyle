...
class TypeManager implements JsonSerializable
{
    ...
    protected $types = [
        ...
        'image' => [
            'display' => 'Image',
            'selector' => '.bard-inline-image-container img',
            'extension' => 'image',
    ...
    public function validateAttribute($attribute)
    {
        ...
        if (! $this->supports($attribute['type'], 'attributes_cp_css')) {
            $attribute['cp_css'] = false;
        }
